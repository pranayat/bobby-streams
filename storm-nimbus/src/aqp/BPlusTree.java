...
public class BPlusTree {
     ...
     */
    private int binarySearch(DictionaryPair[] dps, int numPairs, double t) {
    ...
    /**
     * This method modifies a list of Double-typed objects that represent keys
     * by removing half of the keys and returning them in a separate Double[].
     * This method is used when splitting an InternalNode object.
     *
     * @param keys:  a list of Double objects
     * @param split: the index where the split is to occur
     * @return Double[] of removed keys
     */
     ...
     */
    public void insert(double key, Tuple value) {
        if (isEmpty()) {
     ...
     */
    public Tuple search(double key) {
    ...
    public class DictionaryPair implements Comparable<DictionaryPair> {
         ...
         */
        public DictionaryPair(double key, Tuple value) {
            this.key = key;
            this.value = value;
        }
